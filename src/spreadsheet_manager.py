...
class SpreadSheetManager:
    ...
    def create_spreadsheet_with_results(
        urls: List[str], results: List[Union[bool, str]], filename="results.xlsx"
    ):
        ...
        df = pd.DataFrame({"URL": urls, "Meta Robots Found?": results})
        ...
        with pd.ExcelWriter(filename, engine="xlsxwriter") as writer:
            ...
            worksheet.merge_range(
                ...
                signature_row,
                1,
                "Generated by MetaRobots Finder - by Armando Monteiro",
                signature_format,
            )
